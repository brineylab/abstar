...
schema_dict = {
    ...
    "v_identity_indel": pl.Float64,
    "v_identity_aa_indel": pl.Float64,
    ...
    "c_identity_indel": pl.Float64,
    "c_identity_aa_indel": pl.Float64,
    "c_cigar": pl.String,
    ...
    "cdr3_v_aa": pl.String,
    "cdr3_n1": pl.String,
    "cdr3_n1_aa": pl.String,
    "cdr3_d": pl.String,
    "cdr3_d_aa": pl.String,
    "cdr3_n2": pl.String,
    "cdr3_n2_aa": pl.String,
    "cdr3_j": pl.String,
    "cdr3_j_aa": pl.String,
    ...
    "cdr_mask": pl.String,
    "cdr_mask_aa": pl.String,
    "gene_segment_mask": pl.String,
    "gene_segment_mask_aa": pl.String,
    "nongermline_mask": pl.String,
    "nongermline_mask_aa": pl.String,
}
