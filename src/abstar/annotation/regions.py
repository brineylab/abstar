...
def identify_cdr3_regions(ab: Antibody) -> Antibody:
    ...
    ab.cdr3_v_aa = translate(ab.cdr3_v)
    ...
    ab.cdr3_j_aa = translate(ab.cdr3_j)
    ...
    if ab.d_call is not None:
        ...
        ab.cdr3_d_aa = translate(ab.cdr3_d)
        ...
        ab.cdr3_n1_aa = translate(ab.cdr3_n1)
        ...
        ab.cdr3_n2_aa = translate(ab.cdr3_n2)
